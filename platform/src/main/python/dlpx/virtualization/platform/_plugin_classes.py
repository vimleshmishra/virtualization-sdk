...
__all__ = [
    ...
    "MountSpecification", "LogFile", "PitParameters"
]
...
class LogFile(object):
    def __init__(self, filename, location, timestamp, parameters=None):
    ...
    def to_proto(self):
        ...
        proto = common_pb2.LogFile()
        proto.filename = self._filename
        proto.location = self._location
        proto.timestamp.FromDatetime(self._timestamp)
        proto.parameters.update(self._parameters)
        return proto
...
class PitParameters(object):
    def __init__(self, pit_timestamp, log_files=None):
    ...
    def to_proto(self):
        from dlpx.virtualization.api import common_pb2
        proto = common_pb2.PitParameters()
        proto.pit_timestamp.FromDatetime(self._pit_timestamp)
        proto.log_files.extend([lf.to_proto() for lf in self._log_files])
        return proto

    @classmethod
    def from_proto(cls, proto):
        return cls(
            pit_timestamp=proto.pit_timestamp.ToDatetime(),
            log_files=[LogFile.from_proto(lf) for lf in proto.log_files],
        )
